...
<head>
    ...
    <title>{{ config('app.name', 'Sete Distribuidora') }}</title>
    <meta name="description" content="Franquia para distribuição " />
    <meta name="viewport" content="width=device-width, initial-scale=1" />
                    ...
                    <div class="col-lg-4 col-md-4 col-12">
                        <div class="top-end">
                            ...
                            <ul class="user-login">
                                ...
                                @else
                                    <li><a href="{{ route('login') }}" class="text-sm text-gray-700 dark:text-gray-500 underline">Entrar</a></li>
          
                                    @if (Route::has('register'))
                                        <li><a href="{{ route('register') }}" class="ml-4 text-sm text-gray-700 dark:text-gray-500 underline">Registrar</a></li>
                        ...
                        <nav class="navbar navbar-expand-lg">
                            ...
                            <div class="collapse navbar-collapse sub-menu-bar" id="navbarSupportedContent">
                                <ul id="nav" class="navbar-nav ms-auto">
                                    <li class="nav-item">
                                        <a href="{{ url('/') }}" class="active" aria-label="Toggle navigation">Principal</a>
                                    </li>
                                    <li class="nav-item">
